...
with open('jsb.txt', 'r', encoding='UTF-8') as f:
    for i in f.readlines():
        print(i.strip('\n'))
        # ScoreUserProfile.objects.create(to_score_project_id=1, to_user_profile=UserProfile.objects.get(name__exact=i.strip('\n')))
        UserProfileScoreProject.objects.create(to_score_project_id=1,
